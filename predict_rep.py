...
Mean_Files = []
Mean_Files.append('/home/atom/cifar10/mymodel/rep0/mean.cifar10.npy')
Mean_Files.append('/home/atom/cifar10/mymodel/rep1/mean.cifar10.npy')
Mean_Files.append('/home/atom/cifar10/mymodel/rep2/mean.cifar10.npy')
Mean_Files.append('/home/atom/cifar10/mymodel/rep3/mean.cifar10.npy')
...
for imageFileName in imageFileNames:
    ...
    for idx in range(5):
        prediction = net[idx].predict([input_image])
